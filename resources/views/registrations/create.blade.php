<x-app-layout>
    ...
    @if (session('success') || session('error') || $errors->any())
        <div x-data="{ show: true }" x-show="show" x-transition:enter="transition ease-out duration-300"
            ...
            x-transition:leave-end="opacity-0 -translate-y-4" class="mb-8">

            @if (session('success'))
                <div
                    class="flex items-center justify-between p-5 bg-emerald-50 border border-emerald-100 rounded-[2rem] shadow-sm">
                    <div class="flex items-center gap-4">
                        <div
                            class="w-10 h-10 bg-emerald-500 rounded-xl flex items-center justify-center text-white shadow-lg shadow-emerald-200">
                        ...
                        <div>
                            <p class="text-xs font-black text-emerald-800 uppercase tracking-widest leading-none mb-1">
                                Berhasil Disimpan</p>
            ...
            @if (session('error') || $errors->any())
                <div
                    class="flex items-center justify-between p-5 bg-rose-50 border border-rose-100 rounded-[2rem] shadow-sm">
                    <div class="flex items-center gap-4">
                        <div
                        ...
                        <div>
                            <p class="text-xs font-black text-rose-800 uppercase tracking-widest leading-none mb-1">
                                Terjadi Kesalahan</p>
        ...
        <div class="max-w-[90rem] mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p class="text-slate-500 mt-1 text-sm font-medium">Lengkapi data dan unggah dokumen untuk proses
                        verifikasi seleksi.</p>
                </div>
                <div class="hidden md:block">
                    <span
                        class="px-4 py-2 bg-blue-50 text-blue-600 rounded-2xl text-xs font-black uppercase tracking-widest border border-blue-100">
    ...
    <div class="py-12 bg-[#fcfcfd] min-h-screen relative overflow-hidden">
        ...
        <div class="max-w-[90rem] mx-auto sm:px-6 lg:px-8 relative z-10">
                ...
                <form method="POST" action="{{ route('registrations.store') }}" enctype="multipart/form-data"
                    ...
                    <div class="p-8 md:p-14 space-y-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <label
                                class="relative flex items-center p-8 border-2 border-slate-50 rounded-[2rem] cursor-pointer hover:bg-slate-50 hover:border-blue-200 transition-all group">
                                <input type="radio" name="registration_type" value="student"
                                    class="w-6 h-6 text-blue-600 border-slate-200 focus:ring-blue-500" required>
                                <div class="ml-6">
                                    <span
                                        class="block text-lg font-black text-slate-900 group-hover:text-blue-600 transition-colors">Pendaftaran
                                        Siswa</span>
                                    <span class="block text-sm font-medium text-slate-500">Saya mendaftar sebagai calon
                                        siswa mandiri</span>
                                </div>
                            </label>
                            ...
                            <label
                                class="relative flex items-center p-8 border-2 border-slate-50 rounded-[2rem] cursor-pointer hover:bg-slate-50 hover:border-blue-200 transition-all group">
                                <input type="radio" name="registration_type" value="parent"
                                    class="w-6 h-6 text-blue-600 border-slate-200 focus:ring-blue-500" required>
                                <div class="ml-6">
                                    <span
                                        class="block text-lg font-black text-slate-900 group-hover:text-blue-600 transition-colors">Orang
                                        Tua / Wali</span>
                                    <span class="block text-sm font-medium text-slate-500">Saya mendaftarkan anak atau
                    ...
                    <div class="p-8 md:p-14 space-y-10">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h3 class="text-xs font-black text-slate-400 uppercase tracking-[0.2em]">Langkah 02
                                </h3>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            ...
                            <div class="space-y-3">
                                <label class="text-xs font-black text-slate-400 uppercase tracking-widest ml-1">Tanggal
                                    Lahir</label>
                                <input type="date" name="student_birth_date"
                                    value="{{ old('student_birth_date') }}" required
                                    class="block w-full px-6 py-4 bg-slate-50 border-none rounded-2xl focus:ring-2 focus:ring-blue-600 transition-all font-bold text-slate-700" />
                            </div>

                            <div class="space-y-3">
                                <label class="text-xs font-black text-slate-400 uppercase tracking-widest ml-1">Jenis
                                    Kelamin</label>
                            ...
                            <div class="space-y-3">
                                <label class="text-xs font-black text-slate-400 uppercase tracking-widest ml-1">Tahun
                                    Ajaran</label>
                    ...
                    <div class="p-8 md:p-14 bg-slate-50/30 space-y-10">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h3 class="text-xs font-black text-slate-400 uppercase tracking-[0.2em]">Langkah 03
                                </h3>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            <div class="space-y-3">
                                ...
                                <input type="text" name="parent_name"
                                    class="block w-full px-6 py-4 bg-white border border-slate-100 rounded-2xl focus:ring-4 focus:ring-blue-600/5 focus:border-blue-600 transition-all font-bold text-sm"
                                    placeholder="Nama lengkap wali" />
                            </div>

                            <div class="space-y-3">
                                <label class="text-xs font-black text-slate-400 uppercase tracking-widest ml-1">No.
                                    WhatsApp</label>
                            ...
                            <div class="space-y-3">
                                <label
                                    class="text-xs font-black text-slate-400 uppercase tracking-widest ml-1">Email</label>
                    ...
                    <div class="p-8 md:p-14 space-y-10">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h3 class="text-xs font-black text-slate-400 uppercase tracking-[0.2em]">Langkah 04
                                </h3>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            {{-- Akta Kelahiran --}}
                            <div class="space-y-4">
                                <label class="text-xs font-black text-slate-400 uppercase tracking-widest ml-1">Akta
                                    Kelahiran (PDF/JPG, Max 2MB)</label>
                                <div class="relative group">
                                    ...
                                    <div
                                        class="p-8 border-2 border-dashed border-slate-200 rounded-[2rem] bg-slate-50/50 group-hover:border-blue-400 group-hover:bg-blue-50 transition-all text-center">
                                        <svg class="w-10 h-10 text-slate-300 mx-auto mb-3 group-hover:text-blue-500 transition-colors"
                                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                        </svg>
                                        <p id="file-name-akta"
                                            class="text-sm font-black text-slate-600 tracking-tight">Pilih File Akta
                                        </p>
                                        <p
                                            class="text-[10px] text-slate-400 mt-1 uppercase font-black tracking-widest">
                                            Klik atau seret file</p>
                                    </div>
                                </div>
                            ...
                            {{-- Kartu Keluarga --}}
                            <div class="space-y-4">
                                <label class="text-xs font-black text-slate-400 uppercase tracking-widest ml-1">Kartu
                                    Keluarga (PDF/JPG, Max 2MB)</label>
                                <div class="relative group">
                                    ...
                                    <div
                                        ...
                                        <p id="file-name-kk" class="text-sm font-black text-slate-600 tracking-tight">
                                            Pilih File KK</p>
                                        <p
                                            class="text-[10px] text-slate-400 mt-1 uppercase font-black tracking-widest">
                                            Klik atau seret file</p>
                    ...
                    <div class="p-8 md:p-14 bg-white flex flex-col md:flex-row items-center justify-between gap-6">
                        <a href="{{ route('dashboard') }}"
                            class="group flex items-center gap-3 text-slate-400 hover:text-slate-900 transition-all">
                            <div
                                class="w-10 h-10 rounded-xl flex items-center justify-center group-hover:bg-slate-100 transition-all">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="mt-12 text-center pb-12">
                <p class="text-[10px] font-black text-slate-300 uppercase tracking-[0.5em]">System Secure Connection
                    &bull; Data Encrypted</p>
            </div>
        </div>
    </div>
</x-app-layout>
